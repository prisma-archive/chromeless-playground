...
declare module CM {
  type Position = {line: number, ch: number};
    ...
    function showHint(cm: any, hinter?: (doc: any) => Hints, options?: ShowHintOptions): void;
    ...
    interface Editor {
        ...
        on(eventName: string, handler: (doc: any, event: any) => void): void;
        off(eventName: string, handler: (doc: any, event: any) => void): void;
    }
